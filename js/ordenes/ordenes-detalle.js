        ...
        <div>
          ...
          ${(() => {
            ...
            return `<div class="det-datos-faltantes-banner">
              ...
              ${tienePermiso('editar_ordenes') && orden.estado !== 'Entregada' && orden.estado !== 'Archivada' ? `<button class="btn btn-sm" style="margin-left:auto;flex-shrink:0;background:#FEF3C7;color:#B45309;border:1px solid #FDE68A" onclick="abrirEditarOrden(${orden.id})">Completar datos</button>` : ''}
            </div>`;
          })()}
          <div class="det-sec-box" style="border:1px solid #9FE1CB;border-radius:10px;overflow:hidden;margin-bottom:12px">
            ...
            <div id="det-datos-body" style="${_datosOrdenAbierto?'':'display:none;'}padding:12px">
              <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:10px">
                ...
                ${tienePermiso('editar_ordenes') && orden.estado !== 'Entregada' && orden.estado !== 'Archivada' ? `<button class="btn btn-ghost btn-sm" onclick="abrirEditarOrden(${orden.id})">
